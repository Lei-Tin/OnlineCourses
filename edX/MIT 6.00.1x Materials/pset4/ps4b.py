    ...
    while True:
        ...
        if option == 'n':
            ...
            while True:
                ...
                if option2 == 'u':
                    latestHand = dealHand(HAND_SIZE)
                    currHand = latestHand.copy()
            ...
            try: 
                # Test for exceptions to run the check for having a hand being played
            ...
            while True:
                ...
                if option2 == 'u':
                    playHand(latestHand, wordList, HAND_SIZE)
                    break

                elif option2 == 'c':
                    compPlayHand(latestHand, wordList, HAND_SIZE)
                    break
