...
def getCoD(yVals, estYVals):
    yMean = sum(yVals) / len(yVals)
    
    # Variability of Errors, (Predicted - Actual) ^2
    VoE = 0
    
    # Variability of Data, (Y - Mean)^2
    VoD = 0
    
    for i in range(len(yVals)):
        VoE += (yVals[i] - estYVals[i])**2
        VoD += (yVals[i] - yMean)**2
...
def fitData1(fileName):
    ...
    print("The Coefficient of Determination for the linear function is: " + str(round(getCoD(yVals,estYVals),2)))
    ...
    print("The Coefficient of Determination for the cubic function is: " + str(round(getCoD(yVals,estYVals),2)))
    ...
    # print("The Coefficient of Determination for the Cubic Function is: " + str(round(CoDcubic,2)))
