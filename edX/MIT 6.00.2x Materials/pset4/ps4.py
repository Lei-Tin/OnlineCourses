...
def evaluate_models_on_training(x, y, models):
    ...
    for model in models:
        ...
        yPred = pylab.polyval(model, x)
        
        pylab.plot(x, y, 'bo', label = 'Actual Data')
        pylab.plot(x, yPred, 'r', label = 'Line of Best Fit')
        pylab.title("Coefficients: " + str(model) + "\n" + "R^2 Value: " + str(round(r_squared(y, yPred), 3)))
